...
# source: demoparser/protobufs/cstrike15_gcmessages.proto
...
_CMSGGCCSTRIKE15_V2_MATCHMAKINGGC2SERVERRESERVE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rtime32_event_start', full_name='CMsgGCCStrike15_v2_MatchmakingGC2ServerReserve.rtime32_event_start', index=15,
      number=16, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CMSGGCCSTRIKE15_V2_MATCHMAKINGSERVERRESERVATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='test_token', full_name='CMsgGCCStrike15_v2_MatchmakingServerReservationResponse.test_token', index=14,
...
_CMSGGCCSTRIKE15_V2_CLIENTTOGCREQUESTTICKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gameserver_net_id', full_name='CMsgGCCStrike15_v2_ClientToGCRequestTicket.gameserver_net_id', index=3,
...
_CMSGGCTOCLIENTSTEAMDATAGRAMTICKET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='legacy_time_expiry', full_name='CMsgGCToClientSteamDatagramTicket.legacy_time_expiry', index=0,
      number=1, type=7, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_authorized_steam_id', full_name='CMsgGCToClientSteamDatagramTicket.legacy_authorized_steam_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_authorized_public_ip', full_name='CMsgGCToClientSteamDatagramTicket.legacy_authorized_public_ip', index=2,
      number=3, type=7, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_gameserver_steam_id', full_name='CMsgGCToClientSteamDatagramTicket.legacy_gameserver_steam_id', index=3,
      number=4, type=6, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_gameserver_net_id', full_name='CMsgGCToClientSteamDatagramTicket.legacy_gameserver_net_id', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_signature', full_name='CMsgGCToClientSteamDatagramTicket.legacy_signature', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_app_id', full_name='CMsgGCToClientSteamDatagramTicket.legacy_app_id', index=6,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='legacy_extra_fields', full_name='CMsgGCToClientSteamDatagramTicket.legacy_extra_fields', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='serialized_ticket', full_name='CMsgGCToClientSteamDatagramTicket.serialized_ticket', index=8,
...
_CMSGGCCSTRIKE15_GOTVSYNCPACKET.fields_by_name['data'].message_type = demoparser_dot_protobufs_dot_engine__gcmessages__pb2._CENGINEGOTVSYNCPACKET
...
GameServerPing = _reflection.GeneratedProtocolMessageType('GameServerPing', (_message.Message,), dict(
  ...
  __module__ = 'demoparser.protobufs.cstrike15_gcmessages_pb2'
