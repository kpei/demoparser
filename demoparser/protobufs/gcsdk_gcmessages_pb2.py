...
# source: demoparser/protobufs/gcsdk_gcmessages.proto
...
CMsgSOIDOwner = _reflection.GeneratedProtocolMessageType('CMsgSOIDOwner', (_message.Message,), dict(
  ...
  __module__ = 'demoparser.protobufs.gcsdk_gcmessages_pb2'
