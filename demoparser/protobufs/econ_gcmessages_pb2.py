...
# source: demoparser/protobufs/econ_gcmessages.proto
...
CMsgGCGiftedItems = _reflection.GeneratedProtocolMessageType('CMsgGCGiftedItems', (_message.Message,), dict(
  ...
  __module__ = 'demoparser.protobufs.econ_gcmessages_pb2'
